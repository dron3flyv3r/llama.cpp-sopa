...
enum llm_kv {
    ...
    LLM_KV_MTP_BACKBONE_HIDDEN_SIZE,
    LLM_KV_MTP_NUM_CENTROIDS,
    LLM_KV_MTP_CENTROID_INTERMEDIATE_TOP_K,
...
enum llm_tensor {
    ...
    LLM_TENSOR_MTP_PRE_PROJ,        // gemma4-assistant
    LLM_TENSOR_MTP_POST_PROJ,       // gemma4-assistant
    LLM_TENSOR_MTP_CENTROIDS,       // gemma4-assistant E2B/E4B
    LLM_TENSOR_MTP_TOKEN_ORDERING,  // gemma4-assistant E2B/E4B
